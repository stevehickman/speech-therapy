 ...
 * Generated by bundle.js on 2026-03-15 02:57 UTC
 *
 ...
 *   NamingModule.jsx
 *   ppa-speech-therapy_3_final.jsx
 *
    ...
    for (const w of wordList) {
      ...
      if (entry) {
        ...
        fetch("https://api.anthropic.com/v1/messages", {
          method: "POST",
          headers: { "Content-Type": "application/json", "x-api-key": (localStorage.getItem("ppa_api_key") || ""), "anthropic-version": "2023-06-01", "anthropic-dangerous-direct-browser-access": "true" },
          body: JSON.stringify({
