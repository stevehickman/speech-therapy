#!/usr/bin/env node
/**
 * bundle.js  —  Inline-bundler for Speech Therapy Suite
 *
 ...
 *   outputFile = speech-therapy-bundle.jsx
 */
...
const outputFile = process.argv[4] ?? "speech-therapy-bundle.jsx";
...
// -- 5. Emit the bundle --------------------------------------------------------
const BANNER = `/**
 * Speech Therapy Suite — BUNDLED (single-file build)
