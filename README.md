I have created a prototype AI PPA Speech Therapy tool that is available at the link at the end of this post. I created this tool specifically to allow for customization. My wife's speech therapist  told me that including photos and videos of things connected to her provides an additional emotional trigger to help with speech. This supports both.

I'm also attaching the user doc to this post. Anyone who wants is welcome to try this out.  I'm not asking to be paid for this (though I won't object if you send something my way). However, you should be aware that if you use the locally installed version (which is required to play the video clips), you will need an account with Anthropic - that will cost you less than $10/month depending on your usage (it could be less than $5/month).
